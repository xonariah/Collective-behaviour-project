...
In this project we took the inspiration from the work of Li et al. (2023) \cite{li2023predator} and Olson et al. (2013) \cite{olson2013predator} to explore how survival pressures can drive the emergence of swarming behaviour. 
...
Nevertheless, we then extend our work by providing framework for the introduction of new environmental obstacles and new species with the desite to observe how interspecies interactions lead to new survival strategies.
...
Later on, we introduced a new species to the environment and to placed random obstacles, which simulated more realistic and complex space that challenged the agents to adapt their movement and coordination. 
